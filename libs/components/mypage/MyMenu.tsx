		...
		return (
			<Stack width={'100%'} padding={'30px 24px'}>
				<Stack className={'profile'}>
					...
					<Stack className={'user-info'}>
						...
						<Box component={'div'} className={'user-phone'}>
							<img src={'/img/icons/call.png'} alt={'icon'} />
				...
				<Stack className={'sections'}>
					<Stack className={'section'} style={{ height: user.memberType === 'STORE' ? '228px' : '153px' }}>
						...
						<List className={'sub-section'}>
							...
							<ListItem className={pathname === 'myOrders' ? 'focus' : ''}>
										...
										>
											<div className={'flex-box'}>
												{category === 'myOrders' ? (
													<img className={'com-icon'} src={'/img/icons/myOrders2.png'} alt={'com-icon'} />
												) : (
													<img className={'com-icon'} src={'/img/icons/myOrders2.png'} alt={'com-icon'} />
												)}
												<Typography className={'sub-title'} variant={'subtitle1'} component={'p'}>
