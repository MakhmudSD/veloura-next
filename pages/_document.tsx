	...
	return (
		<Html lang="en">
			<Head>
				...
				{/* SEO */}
				<meta name="keyword" content={'veloura, veloura-jewelry.uz, devex mern, mern nestjs fullstack'} />
				<meta
					name={'description'}
					content={
						'Buy and sell products anywhere anytime in South Korea. Best Products at Best prices on nestar.uz | ' +
