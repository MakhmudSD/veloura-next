...
const Join: NextPage = () => {
  ...
  return (
    <Stack className={`join-page ${loginView ? 'login-view' : 'signup-view'}`}>
      <Stack className={'container'}>
        {/* Single, centered card – we no longer render the right image panel */}
          ...
          <Stack className={'form-card'}>
            ...
            <Box className={'input-wrap'}>
              ...
              <div className={'input-box'}>
                <span>Password</span>
                <input
                  type="text" /* keeping as-is to avoid logic changes */
