            ...
            <Stack spacing={2}>
              ...
              <FormControl fullWidth>
                <Select
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, status: e.target.value as FaqStatus })
                  }
                >
            ...
            <Box component="div">
              <List className="tab-menu">
                ...
                <ListItem
                  ...
                  className={tab === 'blocked' ? 'li on' : 'li'}
                >
              ...
              <Stack className="search-area" sx={{ m: '24px' }}>
                ...
                <OutlinedInput
                  ...
                  endAdornment={
                    <>
                      {searchInput && (
                        <CancelRoundedIcon onClick={() => handleInput('')} />
                      )}
